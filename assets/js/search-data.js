...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        },{id: "nav-academic-amp-nbsp-services",
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-am-co-organizing-the-4th-workshop-on-mining-software-repositories-applications-for-privacy-and-security-at-saner-39-26",
          title: 'I am co-organizing the 4th Workshop on Mining Software Repositories Applications for Privacy...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/nicolasediaz.bsky.social", "_blank");
        },
      },{
        id: 'social-dblp',
        title: 'DBLP',
        section: 'Socials',
        handler: () => {
          window.open("https://dblp.org/pid/177/5981", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%69%63%6F%6C%61%73.%64%69%61%7A-%66%65%72%72%65%79%72%61@%74%75%68%68.%64%65", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/nicoediaz", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0001-6304-771X", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=J6hzYksAAAAJ", "_blank");
        },
      },{
        id: 'social-x',
        title: 'X',
        section: 'Socials',
        handler: () => {
          window.open("https://twitter.com/nicolasediaz", "_blank");
        },
      },];
